...
import { AddAiGovernanceStandardObjectsCommand } from 'src/database/commands/upgrade-version-command/2-23/2-23-workspace-command-1830000000000-add-ai-governance-standard-objects.command';
