...
@Module({
  ...
  providers: [TransactionalOutboxService, DrainOutboxJob, DrainOutboxCronJob, DrainOutboxCronCommand],
  exports: [TransactionalOutboxService, DrainOutboxCronCommand],
})
