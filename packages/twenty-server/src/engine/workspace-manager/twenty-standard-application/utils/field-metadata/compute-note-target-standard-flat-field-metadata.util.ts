...
>): Record<AllStandardObjectFieldName<'noteTarget'>, FlatFieldMetadata> => ({
  ...
  targetSearchEngagementTerms: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'targetSearchEngagementTerms',
      label: i18nLabel(msg`Target`),
      description: i18nLabel(msg`NoteTarget target`),
      icon: 'IconArrowUpRight',
      isNullable: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetSearchEngagementTermsId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  targetClientAccountProfile: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'targetClientAccountProfile',
      label: i18nLabel(msg`Target`),
      description: i18nLabel(msg`NoteTarget target`),
      icon: 'IconArrowUpRight',
      isNullable: true,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.CASCADE,
        joinColumnName: 'targetClientAccountProfileId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
