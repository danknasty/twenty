...
export const buildCompensationExpectationStandardFlatIndexMetadatas = ({now,objectName,workspaceId,standardObjectMetadataRelatedEntityIds,dependencyFlatEntityMaps,twentyStandardApplicationId}:Omit<CreateStandardIndexArgs<'compensationExpectation'>,'context'>):Record<AllStandardObjectIndexName<'compensationExpectation'>,FlatIndexMetadata> => ({
