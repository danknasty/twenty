...
export const buildDiligenceCheckStandardFlatIndexMetadatas = ({now,objectName,workspaceId,standardObjectMetadataRelatedEntityIds,dependencyFlatEntityMaps,twentyStandardApplicationId}:Omit<CreateStandardIndexArgs<'diligenceCheck'>,'context'>):Record<AllStandardObjectIndexName<'diligenceCheck'>,FlatIndexMetadata> => ({
