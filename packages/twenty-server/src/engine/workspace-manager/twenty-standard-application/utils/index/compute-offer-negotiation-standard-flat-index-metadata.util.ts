...
}: Omit<CreateStandardIndexArgs<'offerNegotiation'>, 'context'>): Record<
  AllStandardObjectIndexName<'offerNegotiation'>,
  FlatIndexMetadata
> => ({
  ...
  compensationExpectationIdIndex: createStandardIndexFlatMetadata({
    objectName,
    workspaceId,
    context: {
      indexName: 'compensationExpectationIdIndex',
      relatedFieldNames: ['compensationExpectation'],
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
    twentyStandardApplicationId,
