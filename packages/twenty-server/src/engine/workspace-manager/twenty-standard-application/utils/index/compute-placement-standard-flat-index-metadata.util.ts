...
export const buildPlacementStandardFlatIndexMetadatas = ({now,objectName,workspaceId,standardObjectMetadataRelatedEntityIds,dependencyFlatEntityMaps,twentyStandardApplicationId}:Omit<CreateStandardIndexArgs<'placement'>,'context'>):Record<AllStandardObjectIndexName<'placement'>,FlatIndexMetadata> => ({
...
offerNegotiationIdIndex: createStandardIndexFlatMetadata({objectName,workspaceId,context:{indexName:'offerNegotiationIdIndex',relatedFieldNames:['offerNegotiation']},standardObjectMetadataRelatedEntityIds,dependencyFlatEntityMaps,twentyStandardApplicationId,now}),
});
