...
export const buildReferenceCheckStandardFlatIndexMetadatas = ({now,objectName,workspaceId,standardObjectMetadataRelatedEntityIds,dependencyFlatEntityMaps,twentyStandardApplicationId}:Omit<CreateStandardIndexArgs<'referenceCheck'>,'context'>):Record<AllStandardObjectIndexName<'referenceCheck'>,FlatIndexMetadata> => ({
