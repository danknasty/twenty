...
export const buildSearchCandidacyStandardFlatIndexMetadatas = ({
  now,
  objectName,
  workspaceId,
...
}: Omit<CreateStandardIndexArgs<'searchCandidacy'>, 'context'>): Record<
  AllStandardObjectIndexName<'searchCandidacy'>,
  FlatIndexMetadata
> => ({
