...
export const buildSearchMilestoneStandardFlatIndexMetadatas = ({
  now,
  objectName,
  workspaceId,
...
}: Omit<CreateStandardIndexArgs<'searchMilestone'>, 'context'>): Record<
  AllStandardObjectIndexName<'searchMilestone'>,
  FlatIndexMetadata
> => ({
