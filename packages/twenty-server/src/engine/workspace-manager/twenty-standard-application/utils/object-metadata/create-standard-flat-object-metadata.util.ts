  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isAuditLogged: false,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'eventExternalId',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isAuditLogged: false,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'entityName',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isAuditLogged: false,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'externalEventId',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isAuditLogged: false,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'messageExternalId',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isAuditLogged: false,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'messageFolderId',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  noteTarget: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isSystem: true,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'note',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  taskTarget: ({
    ...
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isSystem: true,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'task',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        isSystem: true,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'type',
      },
      workspaceId,
      standardObjectMetadataRelatedEntityIds,
      twentyStandardApplicationId,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`An off-limits restriction for a search`),
        icon: 'IconBan',
        isSystem: true,
        isUICreatable: false,
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`A confidentiality record for a search`),
        icon: 'IconLock',
        isSystem: true,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'summary',
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`A conflict check`),
        icon: 'IconScale',
        isSystem: true,
        isUICreatable: false,
        labelIdentifierFieldMetadataName: 'summary',
  ...
  >) =>
    createStandardObjectFlatMetadata({
      ...
      context: {
        ...
        description: i18nLabel(msg`An outbox for workspace events`),
