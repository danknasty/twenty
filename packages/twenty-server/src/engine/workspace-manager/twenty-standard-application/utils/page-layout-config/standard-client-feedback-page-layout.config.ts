...
export const STANDARD_CLIENT_FEEDBACK_PAGE_LAYOUT_CONFIG = {
  name: 'Default Client Feedback Layout',
  type: PageLayoutType.RECORD_PAGE,
  objectUniversalIdentifier:
    STANDARD_OBJECTS.clientFeedback.universalIdentifier,
  universalIdentifier:
    STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS.clientFeedbackRecordPage
      .universalIdentifier,
  defaultTabUniversalIdentifier: null,
  tabs: CLIENT_FEEDBACK_PAGE_TABS,
