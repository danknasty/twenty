...
export const STANDARD_CRITERION_EVALUATION_PAGE_LAYOUT_CONFIG = {
  name: 'Default Criterion Evaluation Layout',
  type: PageLayoutType.RECORD_PAGE,
  objectUniversalIdentifier:
    STANDARD_OBJECTS.criterionEvaluation.universalIdentifier,
  universalIdentifier:
    STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS.criterionEvaluationRecordPage
      .universalIdentifier,
  defaultTabUniversalIdentifier: null,
  tabs: CRITERION_EVALUATION_PAGE_TABS,
