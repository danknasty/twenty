...
const EXECUTIVE_PROFILE_PAGE_TABS = {
  home: {
    universalIdentifier:
      STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS.executiveProfileRecordPage.tabs
...
export const STANDARD_EXECUTIVE_PROFILE_PAGE_LAYOUT_CONFIG = {
  name: 'Default Executive Profile Layout',
  ...
  tabs: EXECUTIVE_PROFILE_PAGE_TABS,
