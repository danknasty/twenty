...
> = {
  ...
  [FeatureFlagKey.IS_EXECUTIVE_SEARCH_AI_BOARD_MATRIX_ENABLED]: false,
  [FeatureFlagKey.IS_EXECUTIVE_SEARCH_AI_RESEARCH_ENABLED]: false,
  [FeatureFlagKey.IS_EXECUTIVE_SEARCH_AI_NL_SEARCH_FILTERS_ENABLED]: false,
  [FeatureFlagKey.IS_EXECUTIVE_SEARCH_AI_TARGET_COMPANY_SUGGESTIONS_ENABLED]: false,
  [FeatureFlagKey.IS_EXECUTIVE_SEARCH_AI_RELATIONSHIP_PATH_SUGGESTIONS_ENABLED]: false,
};
