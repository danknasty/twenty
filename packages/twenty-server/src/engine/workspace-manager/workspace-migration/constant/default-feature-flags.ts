...
> = {
  ...
  [FeatureFlagKey.IS_CRITERION_ASSESSMENT_SHADOW_ENABLED]: false,
  [FeatureFlagKey.IS_BOARD_MATRIX_AI_ENABLED]: false,
  [FeatureFlagKey.IS_SEARCH_HEALTH_AI_ENABLED]: false,
};
