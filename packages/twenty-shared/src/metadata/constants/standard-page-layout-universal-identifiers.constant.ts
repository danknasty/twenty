...
export const STANDARD_PAGE_LAYOUT_UNIVERSAL_IDENTIFIERS = {
  ...
  analyticsDashboardConfigRecordPage: {
    universalIdentifier: 'd4e5f6a7-2001-4000-9001-d4e5f6a7000001',
    tabs: {
      home: {
        universalIdentifier: 'd4e5f6a7-2002-4000-9001-d4e5f6a7000002',
        widgets: {
          fields: {
            universalIdentifier: 'd4e5f6a7-2003-4000-9001-d4e5f6a7000003',
          },
        },
      },
      timeline: {
        universalIdentifier: 'd4e5f6a7-2004-4000-9001-d4e5f6a7000004',
        widgets: {
          timeline: {
            universalIdentifier: 'd4e5f6a7-2005-4000-9001-d4e5f6a7000005',
          },
        },
      },
    },
  ...
  analyticsMetricSnapshotRecordPage: {
    universalIdentifier: 'd4e5f6a7-3001-4000-9001-d4e5f6a7000001',
    tabs: {
      home: {
        universalIdentifier: 'd4e5f6a7-3002-4000-9001-d4e5f6a7000002',
        widgets: {
          fields: {
            universalIdentifier: 'd4e5f6a7-3003-4000-9001-d4e5f6a7000003',
          },
        },
      },
      timeline: {
        universalIdentifier: 'd4e5f6a7-3004-4000-9001-d4e5f6a7000004',
        widgets: {
          timeline: {
            universalIdentifier: 'd4e5f6a7-3005-4000-9001-d4e5f6a7000005',
          },
        },
      },
    },
  ...
  analyticsDomainMetricRecordPage: {
    universalIdentifier: 'd4e5f6a7-4001-4000-9001-d4e5f6a7000001',
    tabs: {
      home: {
        universalIdentifier: 'd4e5f6a7-4002-4000-9001-d4e5f6a7000002',
        widgets: {
          fields: {
            universalIdentifier: 'd4e5f6a7-4003-4000-9001-d4e5f6a7000003',
          },
        },
      },
      timeline: {
        universalIdentifier: 'd4e5f6a7-4004-4000-9001-d4e5f6a7000004',
        widgets: {
          timeline: {
            universalIdentifier: 'd4e5f6a7-4005-4000-9001-d4e5f6a7000005',
          },
        },
      },
    },
